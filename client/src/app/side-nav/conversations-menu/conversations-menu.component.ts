...
import { IonAccordionGroup, IonAccordion, IonItemDivider, IonLabel, IonItem, IonIcon, IonList, IonCard, IonButton, IonRouterLink, IonSkeletonText, IonText, IonMenuToggle, IonMenu } from "@ionic/angular/standalone";
...
@Component({
  ...
  imports: [IonText, IonSkeletonText,  ConversationFilterPipe, IonButton, IonCard, IonList, IonIcon, IonItem, IonAccordion, IonAccordionGroup, IonLabel, IonItemDivider, RouterLink, IonRouterLink, IonMenuToggle ],
  standalone: true,
})
